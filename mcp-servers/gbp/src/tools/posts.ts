...
export async function listPosts(pageSize = 20, pageToken?: string) {
...
export async function createPost(post: {
    ...
    event?: { title: string; schedule: unknown };
...
export async function updatePost(postId: string, updates: { summary?: string; callToAction?: { actionType: string; url: string } }) {
    const config = getConfig();
...
export const postTools = {
    ...
    gbp_create_post: {
        ...
        handler: async (args: {
            summary: string; topicType?: string; languageCode?: string;
            callToActionType?: string; callToActionUrl?: string;
            eventTitle?: string; eventStartDate?: string; eventEndDate?: string;
            couponCode?: string; redeemUrl?: string;
        }) => {
            const post: Parameters<typeof createPost>[0] = {
    ...
    gbp_update_post: {
        ...
        handler: async (args: { postId: string; summary?: string }) => {

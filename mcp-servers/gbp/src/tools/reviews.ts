...
export async function listReviews(pageSize = 50, pageToken?: string, orderBy?: string) {
...
export const reviewTools = {
    ...
    gbp_get_review: {
        ...
        handler: async (args: { reviewId: string }) => {
    ...
    gbp_reply_review: {
        ...
        handler: async (args: { reviewId: string; comment: string }) => {

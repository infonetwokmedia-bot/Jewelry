...
async function apiRequest(baseUrl, config, path, method = 'GET', body) {
...
export async function getLocation(readMask) {
    const config = getConfig();
...
export async function updateLocation(updates, updateMask) {
    const config = getConfig();
